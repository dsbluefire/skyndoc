...
const LuxurySamples = () => {
  ...
  // Fetch products from Shopify "Luxury Samples" collection
  const { products: shopifyProducts, loading, error } = useProducts('luxury-samples', 20);
    ...
    return (
      <section className="py-8 bg-white">
        <div className="container">
          <h2 className="section-title mb-6">Luxury Samples</h2>
  ...
  // Show error state
  if (error) {
    console.error('Error loading luxury samples:', error);
      ...
      <div className="container">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-4">
            <h2 className="section-title">Luxury Samples</h2>
          </div>
