    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-12" style={{
      ...
      <div className="w-full max-w-md bg-white rounded-3xl shadow-2xl p-6">
        ...
        <p className="text-center text-gray-500 text-sm mb-4">
          Create your account to save your favorites.
        </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          ...
          <Button
            type="submit"
            className="w-full h-10 text-sm font-semibold rounded-2xl bg-blue-600 hover:bg-blue-700 text-white shadow-lg mt-3"
            disabled={loading || success}
          >
