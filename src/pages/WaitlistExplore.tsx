  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (result.success) {
      ...
      toast({
        ...
        description: "We'll notify you when Explore Box launches.",
      });
    } else {
      toast({
        title: "Error",
          ...
          <div className="flex-1 flex flex-col justify-center">
            ...
            <div className="space-y-4 md:space-y-6">
              ...
              <p className="text-base md:text-lg text-gray-600 leading-relaxed max-w-lg" style={{ fontFamily: "Helvetica, Arial, sans-serif" }}>
                Get 5–7 samples weekly for just $14.99. Discover trusted K-beauty brands with new products each week. Perfect for those who love variety and want to explore different skincare options.
              </p>
            </div>
              ...
              <div className="flex items-center gap-3 p-6 bg-green-50 border border-green-200 rounded-lg max-w-lg">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    We'll notify you when Explore Box launches.
                  </p>
                </div>
              </div>
            )}
...
export default WaitlistExplore;
