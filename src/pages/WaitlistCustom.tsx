  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (result.success) {
      ...
      toast({
        ...
        description: "We'll notify you when Custom Box launches.",
      });
    } else {
      toast({
        title: "Error",
          ...
          <div className="flex-1 flex flex-col justify-center">
            ...
            <div className="space-y-4 md:space-y-6">
              ...
              <p className="text-base md:text-lg text-gray-600 leading-relaxed max-w-lg" style={{ fontFamily: "Helvetica, Arial, sans-serif" }}>
                Get your exact routine delivered weekly for $24.99. Choose your proven favorites with full weekly routine quantities. Swap products anytime to keep your skincare perfect for you.
              </p>
            </div>
              ...
              <div className="flex items-center gap-3 p-6 bg-green-50 border border-green-200 rounded-lg max-w-lg">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    We'll notify you when Custom Box launches.
                  </p>
                </div>
              </div>
            )}
