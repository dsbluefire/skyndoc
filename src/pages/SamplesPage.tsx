...
const SamplesPage = () => {
  const { products: shopifyProducts, loading, error } = useProducts('samples', 50);
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 bg-background">
        <div className="container py-8">
          <h1 className="text-4xl font-bold mb-8">Sample-Sized Products</h1>
          <p className="text-gray-600 mb-8 max-w-3xl">
            Try before you commit with our curated collection of sample-sized K-beauty products. Perfect for testing new products or traveling.
          </p>
